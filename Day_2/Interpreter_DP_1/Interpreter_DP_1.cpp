...
//
// Assignment 1
// Accomidate unique_ptr , Shared_ptr , weak_ref
// Assignment 2
// MOve the code towards std::move expressions lVal, rVal and perfect forwarding
// Assignment 3
// Be creative in bringing in lambdas to this code..
// Assignment 4
// NOnLiteral functions such as Add Mul Div Sub works just on an operator can this be recursed using lambda
// Assignment 5
// Do we have a possibility concedering visit and variants here..
// Assignment 6
// Change NOnLiteral functions such as Add Mul Div Sub  to hold var number of args...
// Think whats suits good here.. tuples or variadic expressions..
// Assignment 7
// Use composing or CRTP or coVariant instead of inheritance..
// Asignment 8
// change the code to house threads / Async threads since its on to heavy lifting JOB!!
// Asignment 9
//
...
public:
    ...
    // 1. use unique_ptr or shared_ptr 2. use rValue instead
...
private:
    Expression* left_;   // Out dated... change to rValue elemenate pointers
    Expression* right_;
...
// an be treated as high order functions
// bring in lambda here.. since Add is a call back function
// use forward here
...
public:
    ...
    Calculator() {
        // can be called as dispatchers.. from now on.
        // Instead of assigining add via lambda dispatch NonLiteral functions such as Add, Mul, Sub ...
...
private:
    // redefine the folowing using rValue and lambda..
